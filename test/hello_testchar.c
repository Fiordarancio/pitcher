...
char*	weight_file = "logs/hello_testchar_wg.txt";	// weights & biases 
char*	prologue_file = "logs/hello_testchar_pr.txt";	// net structure
...
/*		print_char (matrix, DIM_CHAR, DIM_CHAR, "I");*/
		...
		store_noisy_I (matrix, DIM_CHAR, noise);
		for (j=1; j<DIM_LABEL; j++)
			label[j] = 0.0;
		label[0] = 1.0; 
		training_set = insert_example (training_set, matrix, DIM_CHAR*DIM_CHAR, label, DIM_LABEL);
...
/*		print_char (matrix, DIM_CHAR, DIM_CHAR, "L");*/
		...
		store_noisy_L (matrix, DIM_CHAR, noise);
		for (j=0; j<DIM_LABEL; j++)
			label[j] = 0.0;
		label[1] = 1.0; 
		training_set = insert_example (training_set, matrix, DIM_CHAR*DIM_CHAR, label, DIM_LABEL);
...
/*		print_char (matrix, DIM_CHAR, DIM_CHAR, "T");*/
		...
		store_noisy_T (matrix, DIM_CHAR, noise);
		for (j=0; j<DIM_LABEL-1; j++)
			label[j] = 0.0;
		label[2] = 1.0; 
		training_set = insert_example (training_set, matrix, DIM_CHAR*DIM_CHAR, label, DIM_LABEL);
